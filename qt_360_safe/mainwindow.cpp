    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->title->setStyleSheet ("color: #000000");    //字体'360安全卫士11' FFFFFF为白色 000000为黑色
    ui->icon->setStyleSheet ("border-image: url(:/other/images/other/icon.png)");   //对应左上角logo
    ui->pbIcon->setStyleSheet ("border-image: url(:/other/images/other/icon_w.png)");   //对应右上角logo
...
void MainWindow::optionTopBtns () {
    ui->close->setStyleSheet ("border-image: url(:/top/images/top/top_close_b.png);");
    ui->min->setStyleSheet ("border-image: url(:/top/images/top/top_min_b.png);");
...
void MainWindow::showContextMenu ()  {
    ...
    QPoint point = ui->menu->mapToGlobal (QPoint(0, ui->menu->height()));
    contextmenu->hide();
