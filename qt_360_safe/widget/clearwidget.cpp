...
void ClearWidget::optionToolButtons () {
    ...
    //
    optionToolButton (ui->tb1, QIcon(":/horse/images/horse/icon_quanpansaomiao.png"), "单项清理", QSize(34, 32), "horsewidget_toolbutton_1");
    ...
    optionToolButton (ui->tb2, QIcon(":/horse/images/horse/icon_xinrenqu.png"), "自动清理", QSize(34, 32), "horsewidget_toolbutton_1");
    optionToolButton (ui->tb3, QIcon(":/horse/images/horse/icon_xinrenqu.png"), "恢复区", QSize(32, 32), "horsewidget_toolbutton_2");
    optionToolButton (ui->tb4, QIcon(":/horse/images/horse/icon_huifuqu.png"), "维修模式", QSize(32, 32), "horsewidget_toolbutton_2");
    optionToolButton (ui->tb5, QIcon(":/horse/images/horse/icon_shangbaoqu.png"), "上经典版清理", QSize(32, 32),"horsewidget_toolbutton_2");

    //
    optionToolButton (ui->tb6, QIcon(":/horse/images/horse/icon_icon_1.png"), "微信清理", QSize(32, 32), "horsewidget_toolbutton_3");
    optionToolButton (ui->tb7, QIcon(":/horse/images/horse/icon_icon_2.png"), "系统盘瘦身", QSize(32, 32), "horsewidget_toolbutton_3");
    optionToolButton (ui->tb8, QIcon(":/horse/images/horse/icon_icon_3.png"), "查找大文件", QSize(32, 32),"horsewidget_toolbutton_3");
}

void ClearWidget::optionToolButton (QToolButton * tb, QIcon icon, QString text, QSize size, QString property) {
